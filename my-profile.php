            ...
            <?php
                ...
                ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="firstname" id="firstname" value="<?= $user['data']['fname']?>" class="form-control form-control-md" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="lastname" class="form-label" style="font-weight: 500; color: #555;">Lastname</label>
                                <input type="text" name="lastname" id="lastname" value="<?= $user['data']['lname']?>" class="form-control form-control-md" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="email" id="email" value="<?= $user['data']['email']?>" class="form-control form-control-md" disabled>
                    </div>

                    <div class="mb-3">
                        <label for="phone" class="form-label" style="font-weight: 500; color: #555;">Phone</label>
                        <input type="text" name="phone" id="phone" value="<?= $user['data']['phone']?>" class="form-control form-control-md" disabled>
                    </div>

                    <div class="d-flex justify-content-between align-items-center">
                        <a href="my-profile-edit.php?id=<?= $user['data']['id'];?>" class="btn text-white" style="font-weight: 500; background-color: #312922;">Edit</a>
                        <a href="index.php" class="btn btn-link" style="font-weight: 500; color: #312922;">Back</a>
                    </div>
